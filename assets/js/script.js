/**Because Bootstrap doesn't have any special variables that webpack doesn't understand, the only thing we need to do is require the package at the top of the script.js file refer to main.bundle.js for additional notes*/
require("bootstrap");
//importing images after removing all other functions  the only function left are carousel specific.after using including file-loader to optimize images we now have to import the images and then update img value in the array 
  ...
  const carouselSlides = [
    {
      ...
      img: img1,//changed from image path to a variable which will be created by file-loader 
...
//****Modularizing pulling out page spefic code and establishing helper and DOM specific functions which are imported and exported according to be used with multiple files */

//*********exported to domMethods.js since this function is specific to the DOM**********
// $(document).ready(function() {
...
//*********exported to helper.js since this function is helper function**********
// function createLoremIpsum(numWords = 50) {
/*   const loremIpsum =
      lorem ipsum was deleted
*/
//   const result = loremIpsum.split(/\s+/).slice(0, numWords).join(" ");
//   return result;
// }
//*********exported to schedule.js since this function is specific to that page**********
...
//*********exported to event.js since this function is specific to that page**********
...
//   return result;
// };
//*********exported to tickets.js since this function is specific to that page**********
